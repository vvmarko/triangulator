...
echo " "
echo "This script is obsolete, kept only for reference (and may be deleted altogether in the future)."
echo "Do not use it. Instead, use cmake infrastructure for building, see README.md for instructions."
echo "Exiting."
echo " "
...
####################################################################################
# Everything below is obsolete, and will be removed eventually. Use cmake instead. #
####################################################################################
